...
const ZhTranslations = require('./snippets/zh_CN');
...
class SnippetsPlugin extends PluginInterface
{
    ...
    async setup(props)
    {
        ...
        TranslationsMapper.forConfig(this.gameManager.config.client, ZhTranslations, false, 'zh_CN');
        /** @type {string} */
        this.activeLocale = this.gameManager.initialGameData?.userLocale?.locale.locale || 'zh_CN';
